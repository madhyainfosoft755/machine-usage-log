...
import { addInstitute, addMachines, getDepartments, getDesignations, getInstitutes, getMachines, updateInstitute, updateMachines } from "../../api/AdminApi";
...
const Designation = () => {
    ...
    const columns = ['Sno.', 'MACHINE NAME', 'ACTION'];
    ...
    const handleUpdate = async () => {
        ...
        const addedinst = await updateMachines({ machine_name: instituteName }, updateId);
