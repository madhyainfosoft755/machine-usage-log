...
const keys = ['id', 'user_name', 'api_name', 'CreatedAt']
const columns = ['id', 'Username', 'Api', 'Time'];
import { Pagination } from 'flowbite-react';
import { useEffect, useState } from 'react';
import { getApiLogs } from '../../api/AdminApi';
...
const AuditTrail = () => {
    ...
    useEffect(() => {
        async function FetchApi() {
            const institutes = await getApiLogs(currentPage, 15);
